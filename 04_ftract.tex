...
The main question of this thesis is whether it is possible to generalize the methodology used by Seguin et al. to TMS-EEG data. Before diving into that, let us devote this chapter to a closer investigation of the aforementioned paper and our experiments with the Functional Brain Tractography project (F-TRACT) iEEG functional data.  
