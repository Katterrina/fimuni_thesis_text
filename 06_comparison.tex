...
\begin{figure}
  \begin{center}
    \includegraphics[width=\textwidth]{images/nootebook_generated/tmseeg_ftract_comparison_results/200ms/AUC/Response_probability_vs_AUC_in_TMS-EEG_in_Schaefer200_mapped_to_Glasser_parcellation.png}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=\textwidth]{images/nootebook_generated/tmseeg_ftract_comparison_results/200ms/FP/Response_probability_vs_first_peak_height_in_TMS-EEG_in_Schaefer200_mapped_to_Glasser_parcellation.png}
  \end{center}
